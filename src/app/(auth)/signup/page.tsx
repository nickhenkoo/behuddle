...
import { signUp, loginWithGoogle } from "@/lib/supabase/actions";

const GoogleIcon = () => (
  <svg viewBox="0 0 24 24" width="18" height="18" xmlns="http://www.w3.org/2000/svg">
    <path d="M23.5 12.28c0-.85-.08-1.66-.22-2.45H12v4.62h6.46c-.28 1.5-1.12 2.76-2.4 3.61v3h3.87c2.26-2.09 3.57-5.17 3.57-8.78z" fill="#4285F4" />
    <path d="M12 24c3.24 0 5.96-1.07 7.94-2.91l-3.87-3c-1.08.72-2.46 1.15-4.07 1.15-3.13 0-5.78-2.11-6.73-4.96H1.28v3.1A11.99 11.99 0 0 0 12 24z" fill="#34A853" />
    <path d="M5.27 14.28A7.2 7.2 0 0 1 4.93 12c0-.79.13-1.55.35-2.28V6.62H1.28A11.98 11.98 0 0 0 0 12c0 1.93.46 3.76 1.28 5.38l3.99-3.1z" fill="#FBBC05" />
    <path d="M12 4.75c1.76 0 3.34.6 4.58 1.79l3.43-3.43C17.95 1.18 15.23 0 12 0 7.42 0 3.19 2.7 1.28 6.62l3.99 3.1C6.22 6.86 8.87 4.75 12 4.75z" fill="#EA4335" />
  </svg>
);
...
export default function SignupPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (missing.length) { setError(`Please enter your ${missing.join(' and ')}.`); return; }
      ...
      <div className="relative flex-1 bg-[#1a1e19] text-white p-8 md:p-16 flex flex-col justify-between hidden md:flex">
        ...
        >
          ...
          <p className="text-[1.1rem] text-sage-light/60 font-light leading-relaxed">
            Join the community of makers and visionaries building the next big thing.
          </p>
        </motion.div>
        ...
        >
          <div className="mb-10 text-center">
            ...
            <p className="text-[14px] text-secondary font-light">
              Start finding your perfect co-founder.
            </p>
          </div>
          ...
          <AnimatePresence mode="wait">
            {sent ? (
              ...
              >
                ...
                <p className="text-[13px] text-secondary">We sent a magic link to your email. Click it to finish signing up.</p>
              </motion.div>
            ) : (
              <motion.div key="form">
                <button
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  <div className="space-y-1.5">
                    <label htmlFor="full_name" className="block text-[13px] font-medium text-foreground">What&apos;s your full name?</label>
                    <input
                      id="full_name"
                      type="text"
                      name="full_name"
